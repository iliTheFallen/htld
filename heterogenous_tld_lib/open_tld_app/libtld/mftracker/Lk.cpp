...
#else
	cv::Point2f *points[3] = {NULL, NULL, NULL};
#endif
 ...
 */
#ifndef USE_HTLD
	void euclideanDistance(CvPoint2D32f *point1, 
		                   CvPoint2D32f *point2, 
						   float *match, 
						   int nPts)
#else
	void euclideanDistance(cv::Point2f *point1, 
		                   cv::Point2f *point2, 
						   float *match, 
						   int nPts)
 ...
 */
#ifndef USE_HTLD
	void normCrossCorrelation(IplImage *imgI, 
		                      IplImage *imgJ,
