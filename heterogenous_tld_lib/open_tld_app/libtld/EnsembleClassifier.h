...
public:
	...
	bool filter(int i);
#endif
	int calcFernFeaturePatch(const unsigned char *blurredImg, int windowIdx, int treeIdx);
    void calcFeatureVectorPatch(const unsigned char *blurredImg, int windowIdx, int *featureVector);
